			...
			Main.PlaySound(SoundID.Item10, projectile.position);
                ...
                if (projectile.owner == Main.myPlayer)
                {
	                for (int i = 0; i < 2; i++)
	                {
                        ...
                        Projectile.NewProjectile(projectile.position.X + speedX, projectile.position.Y + speedY, speedX, speedY, mod.ProjectileType("ChloroDartNew"), (int)(projectile.damage * 0.5), 0f, projectile.owner, 0f, 0f);
	                }
                }
        }
